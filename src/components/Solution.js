export default function Information() {
   return (
      <div className="w-full bg-primary mx-auto px-4 my-24 flex items-center justify-center scroll-mt-20" id={"solution"}>
         <div className="max-w-screen-xl text-center py-10 flex flex-col justify-center items-center h-full">
           <h2 className="text-3xl text-white font-semibold">Die Lösung - Dein individuelles Abomodell</h2>
         <p className="text-lg p-4 text-white dark:text-background-dark">Du erhältst eine maßgeschneiderte Website zu einem festen monatlichen Preis. Das Paket umfasst nicht nur die Erstellung der Website, sondern je nach Option auch das Hosting, die Domainkosten und ein anpassbares Service-Paket während der gesamten Laufzeit. Das Abonnement-Modell deckt alle deine Bedürfnisse ab, ohne versteckte Kosten. Ich kümmere mich um jegliche Art von Anpassungen. So kannst du dich auf dein Business konzentrieren und musst dir keine Sorgen um deine Website machen.</p>
         <a
              href="#contact"
